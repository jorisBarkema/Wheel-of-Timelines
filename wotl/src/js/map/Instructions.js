...
function Instructions(props) {
    ...
    return (
        <div id="instructions" className="d-none d-sm-block col-sm-3 event-container">
            ...
            <p>
                If you like this website, please support it via <span style={{display: "inline-block"}}><a href="https://www.patreon.com/wheeloftimelines"><img className="inline-img" src={images('./patreon-logo.png').default} alt="Patreon" /> Patreon</a></span>,
                it really makes a difference!< br />
                <br />
                In the <span style={{display: "inline-block"}}><img src={images('./icons8-settings-48.png').default} alt="Filters" /> Settings menu</span> you can show or hide the timeline and the character routes along with some other customisation options. <br />
                <br />
